...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Blackout', 'Value 1: Tween duration\nValue 2: How much to stay (if \"on or off then it acts as a switch\")'],
		['Change Stage', 'Value 1: Stage name ("stage" by default)\nValue 2: Change mode (still wip)']
	];
